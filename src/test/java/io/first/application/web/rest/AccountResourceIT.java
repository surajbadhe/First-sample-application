package io.first.application.web.rest;

import io.first.application.SampleApplicationApp;
import io.first.application.config.Constants;
import io.first.application.domain.Authority;
import io.first.application.domain.PersistentToken;
import io.first.application.domain.User;
import io.first.application.repository.AuthorityRepository;
import io.first.application.repository.PersistentTokenRepository;
import io.first.application.repository.UserRepository;
import io.first.application.security.AuthoritiesConstants;
import io.first.application.service.MailService;
import io.first.application.service.UserService;
import io.first.application.service.dto.PasswordChangeDTO;
import io.first.application.service.dto.UserDTO;
import io.first.application.web.rest.errors.ExceptionTranslator;
import io.first.application.web.rest.vm.KeyAndPasswordVM;
import io.first.application.web.rest.vm.ManagedUserVM;
